...
@section('dashboard_content') {{-- Content goes into the dashboard layout's section --}}
    ...
    {{-- Business User Dashboard Content --}}
    @if (Auth::user()->isBusiness())
        {{-- Analytics Summary Blocks - Redesigned for a cooler, matured look --}}
        {{-- Using grid for a cleaner layout with consistent spacing --}}
    ...
    {{-- Regular User Dashboard Content (Your Bookings Block) --}}
    @if (Auth::user()->isRegular())
         {{-- User Details Block (for regular users) --}}
        {{-- This block was already styled in the previous step --}}
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        {{-- Added bg-white, rounded-lg, shadow-md, p-6 for styling --}}
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            @else
                <div class="bg-gray-100 rounded-lg p-4 text-center text-gray-600">
                    <p>You have no bookings yet.</p>
                     <p class="mt-4">Find a barbershop and <a href="{{ route('barbershops.index') }}" class="text-blue-600 hover:underline">make a booking</a>!</p> {{-- Assuming barbershops.index is your search page --}}
                </div>
            @endif
        </div>
    @endif
